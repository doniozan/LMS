    ...
    <nav class="side-menu">
        <ul class="side-menu-list">
            ...
            <li class="gold with-sub">
                ...
                <ul>
                    <li><a href=""><span class="lbl">Proposals</span></a></li>
                    <li><a href=""><span class="lbl">Estimates</span></a></li>
                    <li><a href=""><span class="lbl">Invoices</span></a></li>
                    <li><a href=""><span class="lbl">Payments</span></a></li>
                    <li><a href=""><span class="lbl">Items</span></a></li>
                </ul>
            </li>
            <li class="blue-dirty">
                <a href="tables.html">
            ...
            <li class="orange-red with-sub">
                <span>
                    <i class="font-icon font-icon-help"></i>
                    <span class="lbl">KNOWLEDGE BASE</span>
                </span>
                <ul>
                    <li><a href=""><span class="lbl">Add Article</span></a></li>
                    <li><a href=""><span class="lbl">All Articles</span></a></li>
                    <li><a href=""><span class="lbl">Groups</span></a></li>
                </ul>
            </li>
            <li class="blue with-sub">
                <span>
                ...
                <ul>
                    <li><a href="/setupstaff"><span class="lbl">Staff</span></a></li>
                    <li><a href="/setupdepartment"><span class="lbl">Departments</span></a></li>
                    <li><a href="/setupsources"><span class="lbl">Sources</span></a></li>
                    <li><a href="/setupstatuses"><span class="lbl">Statuses</span></a></li>
                    <li><a href=""><span class="lbl">Email Integration</span></a></li>
                </ul>
            </li>
        </ul>
    </nav>
